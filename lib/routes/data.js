...
router.post('/test', async(req, res) => {
  ...
  await utils.writeImage(d, `./data/uploads/${require('randomstring').generate(10)}.jpg`)
  ...
  utils.checkParameters([report_id, report_date, user_id, report_state, report_description, report_title])
    ...
    .then(async(success) => {
      ...
      if(images){
        ...
        for(image in images){
          imgs.push(utils.writeImage(image, `./data/uploads/${report_id}/${require('randomstring').generate(10)}.jpg`))
        }
...
router.post('/addGuestReport', async(req, res) => {
  ...
  utils.checkParameters(report_id, report_date, report_longitude, report_latitude, report_height, report_state)
    ...
    .then(async(success) => {
      ...
      if(image)
        await utils.writeImage(image, `./data/uploads/${report_id}/${require('randomstring').generate(10)}.jpg`)
